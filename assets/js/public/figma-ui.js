(() => {
  const assets = [
    ...
    ['style','proposalWindowsFigmaStyles','./assets/css/public/proposal-windows-figma.css?v=2.0'],
    ['style','adminCardIconsStyles','./assets/css/public/admin-card-icons.css?v=1.1'],
    ['script','proposalWindowsFigmaScript','./assets/js/public/proposal-windows-figma.js?v=2.0'],
