(() => {
  ...
  async function checkAdmin() {
    ...
    document.querySelectorAll('[data-auction-shortcut]').forEach(button=>{button.hidden=!isAdmin&&button.dataset.auctionShortcut!=='wheel';});
  ...
  function switchTab(button){const target=button.dataset.auctionTab||button.dataset.auctionShortcut;document.querySelectorAll('[data-auction-tab]').forEach(x=>x.classList.toggle('active',x.dataset.auctionTab===target));document.querySelectorAll('[data-auction-shortcut]').forEach(x=>x.classList.toggle('active',x.dataset.auctionShortcut===target));document.querySelectorAll('[data-auction-panel]').forEach(x=>{const active=x.dataset.auctionPanel===target;x.hidden=!active;x.classList.toggle('active',active);});}
  ...
  document.querySelectorAll('[data-auction-shortcut]').forEach(button=>button.addEventListener('click',()=>switchTab(button)));
